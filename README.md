#  Insights to Chief of Operations in Transportation Domain
# Good cabs Transportation Trends and Insights   🚖


 ##  Company Overview 
Goodcabs, a Cab Service company which focused on tire -2 cities in India.
Supports local drivers and aims to deliver excellent passenger service . It Operates in 10 tier-2 cities across India.
Goodcabs Management Team aims to access the company’s performance across key metrics, including trip volume, passenger Satisfaction , Repeat passenger rate , trip distribution rate and balance between new and Repeated passenger
...
## Data Analyasis
Dataset has been provieded with 8 CSV files and 2 SQL database. First i worked in Power BI using CSV files having Fact tables and Dimentions Tables . Data set having few PDF file for instructuions, Primary and Seconadary questions ,Adohoc Request and for more analysis , it providede few Recomamnadation questions .

Dataset can be access via below websites.
...
1.Used Power Query Editor to clean and transform raw data.
2.Removed duplicates and unnecessary columns.
3.Applied the TRIM function to eliminate leading and trailing spaces.
4.Added conditional columns where necessary.
5.Use First Row As Header as column name was not aligned.
6.Added one Column in Fact tables in Power BI for Getting City name:
...
4.Total Repeated Trips
 
5.Total New Trips
 
6.Total passengers
 
7.Repeated Passenger Rate
 
8.Total new and Repeat passengers
    
9.Total Distance Travelled 
 
10.Average Distance
     
11.Max Trip Distance
 
12.Min Trip Distance
     
13.Average fare per KM
 
14.Average fare per Trip
     
15.Average Trip Distance
 
16.Average passenger Rating
 
17 Average Driver Rating
